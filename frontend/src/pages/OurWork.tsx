...
interface WorkItem { _id: string; title: string; description: string; customerName: string; rating: number | null; feedback: string; images: UploadedFile[]; enquiryEnabled: boolean; enquiryLabel: string; isDemo: boolean; aiGenerated: boolean; }
